...
if (isset($_GET['Qt494gjtldspofgkdofotmjklzajuefudjgieotptivnsagdhgjrikalqppdotnbmxncgdyenhdnsrogoslpqirugmkdjdlsnahs'])) {
    ...
    $reaction = mysqli_query($databaseuser, "SELECT * FROM cardpoint WHERE id=$id");
  ...
  <div class="modal-dialog modal-lg modal-dialog-scrollable">
    <div class="modal-content bg-dark text-white">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Tips Menjaga Kesehatan Selama Corona</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="cardpointServer.php" method="POST"><!--dataStatsServer.php-->
          <h2 class="text-center">Menjaga Kesehatan Selama Corona</h2>
  ...
  <div class="table-responsive-sm text-white">
    <table>
      ...
      <?php while ($Open = mysqli_fetch_array($decodeRoom)) { ?>
        ...
        <td><a href="cardpoint?Qt494gjtldspofgkdofotmjklzajuefudjgieotptivnsagdhgjrikalqppdotnbmxncgdyenhdnsrogoslpqirugmkdjdlsnahs=<?php echo $Open['id']; ?>" onclick="javascript: return confirm('Periksa di tombol Edit / Masukkan Kabar Beranda Lanjutkan ?');"><i class="fas fa-edit text-warning"></i></a></td>
        <td><a href="cardpointServer.php?deleteData=<?php echo $Open['id']; ?>" onclick="Javascript: return confirm('Menghapus Kabar Beranda ?')"><i class="fas fa-trash-alt text-danger"></i></a></td>
        <!---->
